...
public class TradeHandler implements IVillageTradeHandler {
	...
	public void manipulateTradesForVillager(EntityVillager villager, MerchantRecipeList recipeList, Random random) {
		...
		if (villager.getProfession() == Brewcraft.configuration.get("General", "Witch Profession ID", 15).getInt()) {
			...
			recipeList.add(new MerchantRecipe(new ItemStack(Items.emerald, random.nextInt(5) + 3),
					new ItemStack(PotionPlugin.potions, 1, random.nextInt(1) + 1)));
			recipeList.add(new MerchantRecipe(new ItemStack(Items.emerald, random.nextInt(5) + 3),
					new ItemStack(PotionPlugin.potions, 1, random.nextInt(1) + 10)));
			recipeList.add(new MerchantRecipe(new ItemStack(Items.emerald, random.nextInt(5) + 5),
					new ItemStack(PotionPlugin.potions, 1, random.nextInt(1) + 20)));
			recipeList.add(new MerchantRecipe(new ItemStack(Items.emerald, random.nextInt(5) + 6),
			...
			recipeList.add(new MerchantRecipe(new ItemStack(Items.emerald, random.nextInt(5) + 8),
			...
			recipeList.add(new MerchantRecipe(new ItemStack(Items.emerald, random.nextInt(5) + 9),
			...
			recipeList.add(new MerchantRecipe(new ItemStack(Items.emerald, random.nextInt(5) + 7),
			...
			recipeList.add(new MerchantRecipe(new ItemStack(Items.emerald, random.nextInt(5) + 2),
		...
		if (villager.getProfession() == Brewcraft.configuration.get("General", "Warlock Profession ID", 16).getInt()) {
			...
			recipeList.add(new MerchantRecipe(new ItemStack(Items.emerald, random.nextInt(4) + 3),
					new ItemStack(Items.speckled_melon, 2)));
			recipeList.add(new MerchantRecipe(new ItemStack(Items.emerald, random.nextInt(4) + 4),
					new ItemStack(Items.blaze_powder, random.nextInt(2) + 1)));
			recipeList.add(new MerchantRecipe(new ItemStack(Items.emerald, random.nextInt(3) + 1),
					new ItemStack(Items.sugar, random.nextInt(2) + 3)));
			recipeList.add(new MerchantRecipe(new ItemStack(Items.emerald, random.nextInt(3) + 4),
			...
			recipeList.add(new MerchantRecipe(new ItemStack(Items.emerald, random.nextInt(4) + 2),
			...
			recipeList.add(new MerchantRecipe(new ItemStack(Items.emerald, random.nextInt(4) + 6),

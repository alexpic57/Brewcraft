...
public class PotionPlugin implements IPlugin {
	...
	public void Init(ModUtils mod) {
		...
		fluidWitherIII = potionRegistry.addPotion(null, "WitherIII", ModMobEffects.WITHER, 5, 2);
		...
		fluidRegenIII = potionRegistry.addPotion(null, "RegenIII", ModMobEffects.REGENERATION, 8, 2);
		...
		fluidPoisonIII = potionRegistry.addPotion(null, "PoisonIII", ModMobEffects.POISON, 8, 2);
		...
		//Brewcraft potions.
		fluidHolyWater = potionRegistry.addPotion(null, "HolyWater", ModMobEffects.ANGEL, 10, 0, true);
		fluidHolyWaterII = potionRegistry.addPotion(null, "HolyWaterII", ModMobEffects.ANGEL, 5, 1, true);
		fluidHolyWaterLong = potionRegistry.addPotion(null, "HolyWaterLong", ModMobEffects.ANGEL, 20, 0, true);
		fluidHolyWaterVeryLong = potionRegistry.addPotion(null, "HolyWaterVeryLong", ModMobEffects.ANGEL, 40, 0, true);
		fluidHolyWaterIII = potionRegistry.addPotion(null, "HolyWaterIII", ModMobEffects.ANGEL, 3, 2, true);
		fluidFlight = potionRegistry.addPotion(null, "Flight", ModMobEffects.FLIGHT, 15, 0);
		fluidFlightLong = potionRegistry.addPotion(null, "FlightLong", ModMobEffects.FLIGHT, 30, 0);
		fluidFlightVeryLong = potionRegistry.addPotion(null, "FlightVeryLong", ModMobEffects.FLIGHT, 60, 0);
		fluidAntidote = potionRegistry.addPotion(null, "Antidote", ModMobEffects.IMMUNITY, 60, 0, true);
		fluidAntidoteII = potionRegistry.addPotion(null, "AntidoteII", ModMobEffects.IMMUNITY, 45, 1, true);
		fluidAntidoteIII = potionRegistry.addPotion(null, "AntidoteIII", ModMobEffects.IMMUNITY, 30, 2, true);
		fluidAntidoteIIII = potionRegistry.addPotion(null, "AntidoteIIII", ModMobEffects.IMMUNITY, 20, 3, true);
		fluidAntidoteLong = potionRegistry.addPotion(null, "AntidoteLong", ModMobEffects.IMMUNITY, 120, 0, true);
		fluidAntidoteVeryLong = potionRegistry.addPotion(null, "AntidoteVeryLong", ModMobEffects.IMMUNITY, 240, 0, true);
		fluidBoom = potionRegistry.addPotion(null, "Boom", ModMobEffects.CREEPER, 8, 0, true);
		fluidBoomII = potionRegistry.addPotion(null, "BoomII", ModMobEffects.CREEPER, 4, 1, true);
		fluidBoomIII = potionRegistry.addPotion(null, "BoomIII", ModMobEffects.CREEPER, 4, 2, true);
		fluidBoomLong = potionRegistry.addPotion(null, "BoomLong", ModMobEffects.CREEPER, 16, 0, true);
		fluidBoomVeryLong = potionRegistry.addPotion(null, "BoomVeryLong", ModMobEffects.CREEPER, 32, 0, true);
		fluidCryo = potionRegistry.addPotion(null, "Cryo", ModMobEffects.FROZEN, 8, 0, true);
		fluidCryoLong = potionRegistry.addPotion(null, "CryoLong", ModMobEffects.FROZEN, 16, 0, true);
		fluidCryoVeryLong = potionRegistry.addPotion(null, "CryoVeryLong", ModMobEffects.FROZEN, 30, 0, true);
		fluidEternalFlame = potionRegistry.addPotion(null, "EternalFlame", ModMobEffects.FLAME, 30, 0);
		fluidEternalFlameLong = potionRegistry.addPotion(null, "EternalFlameLong", ModMobEffects.FLAME, 60, 0);
		fluidEternalFlameVeryLong = potionRegistry.addPotion(null, "EternalFlameVeryLong", ModMobEffects.FLAME, 120, 0);
		fluidFireImmunity = potionRegistry.addPotion(null, "FireImmunity", ModMobEffects.FIREPROOF, 35, 0, true);
		fluidFireImmunityLong = potionRegistry.addPotion(null, "FireImmunityLong", ModMobEffects.FIREPROOF, 70, 0, true);
		fluidFireImmunityVeryLong = potionRegistry.addPotion(null, "FireImmunityVeryLong", ModMobEffects.FIREPROOF, 140, 0, true);
		fluidFireImmunityII = potionRegistry.addPotion(null, "FireImmunityII", ModMobEffects.FIREPROOF, 15, 1, true);
		fluidFireImmunityIII = potionRegistry.addPotion(null, "FireImmunityIII", ModMobEffects.FIREPROOF, 10, 2, true);
		fluidFireImmunityIIII = potionRegistry.addPotion(null, "FireImmunityIIII", ModMobEffects.FIREPROOF, 5, 3, true);
		fluidFireEater = potionRegistry.addPotion(null, "FireEater", ModMobEffects.FIRE_EATER, 45, 0, true);
		fluidFireEaterII = potionRegistry.addPotion(null, "FireEaterII", ModMobEffects.FIRE_EATER, 30, 1, true);
		fluidFireEaterIII = potionRegistry.addPotion(null, "FireEaterIII", ModMobEffects.FIRE_EATER, 15, 2, true);
		fluidFireEaterLong = potionRegistry.addPotion(null, "FireEaterLong", ModMobEffects.FIRE_EATER, 90, 0, true);
		fluidFireEaterVeryLong = potionRegistry.addPotion(null, "FireEaterVeryLong", ModMobEffects.FIRE_EATER, 180, 0, true);
		...
		potionRegistry.addPotion(fluidRegenIII, vials, "RegenIII", ModMobEffects.REGENERATION, 3, 2);
		...
		potionRegistry.addPotion(fluidPoisonIII, vials, "PoisonIII", ModMobEffects.POISON, 3, 2);
		...
		potionRegistry.addPotion(fluidWitherIII, vials, "WitherIII", ModMobEffects.WITHER, 3, 2);
		...
		potionRegistry.addPotion(fluidHolyWater, vials, "HolyWater", ModMobEffects.ANGEL, 5, 0, true);
		potionRegistry.addPotion(fluidHolyWaterII, vials, "HolyWaterII", ModMobEffects.ANGEL, 5, 1, true);
		potionRegistry.addPotion(fluidHolyWaterLong, vials, "HolyWaterLong", ModMobEffects.ANGEL, 10, 0, true);
		potionRegistry.addPotion(fluidHolyWaterVeryLong, vials, "HolyWaterVeryLong", ModMobEffects.ANGEL, 20, 0, true);
		potionRegistry.addPotion(fluidHolyWaterIII, vials, "HolyWaterIII", ModMobEffects.ANGEL, 3, 2, true);
		potionRegistry.addPotion(fluidFlight, vials, "Flight", ModMobEffects.FLIGHT, 5, 0);
		potionRegistry.addPotion(fluidFlightLong, vials, "FlightLong", ModMobEffects.FLIGHT, 20, 0);
		potionRegistry.addPotion(fluidFlightVeryLong, vials, "FlightVeryLong", ModMobEffects.FLIGHT, 30, 0);
		potionRegistry.addPotion(fluidAntidote, vials, "Antidote", ModMobEffects.IMMUNITY, 15, 0, true);
		potionRegistry.addPotion(fluidAntidoteII, vials, "AntidoteII", ModMobEffects.IMMUNITY, 10, 1, true);
		potionRegistry.addPotion(fluidAntidoteIII, vials, "AntidoteIII", ModMobEffects.IMMUNITY, 10, 2, true);
		potionRegistry.addPotion(fluidAntidoteIIII, vials, "AntidoteIIII", ModMobEffects.IMMUNITY, 5, 3, true);
		potionRegistry.addPotion(fluidAntidoteLong, vials, "AntidoteLong", ModMobEffects.IMMUNITY, 60, 0, true);
		potionRegistry.addPotion(fluidAntidoteVeryLong, vials, "AntidoteVeryLong", ModMobEffects.IMMUNITY, 120, 0, true);
		potionRegistry.addPotion(fluidBoom, vials, "Boom", ModMobEffects.CREEPER, 4, 0, true);
		potionRegistry.addPotion(fluidBoomII, vials, "BoomII", ModMobEffects.CREEPER, 4, 1, true);
		potionRegistry.addPotion(fluidBoomIII, vials, "BoomIII", ModMobEffects.CREEPER, 4, 2, true);
		potionRegistry.addPotion(fluidBoomLong, vials, "BoomLong", ModMobEffects.CREEPER, 8, 0, true);
		potionRegistry.addPotion(fluidBoomVeryLong, vials, "BoomVeryLong", ModMobEffects.CREEPER, 16, 0, true);
		potionRegistry.addPotion(fluidCryo, vials, "Cryo", ModMobEffects.FROZEN, 2, 0, true);
		potionRegistry.addPotion(fluidCryoLong, vials, "CryoLong", ModMobEffects.FROZEN, 8, 0, true);
		potionRegistry.addPotion(fluidCryoVeryLong, vials, "CryoVeryLong", ModMobEffects.FROZEN, 20, 0, true);
		potionRegistry.addPotion(fluidEternalFlame, vials, "EternalFlame", ModMobEffects.FLAME, 10, 0);
		potionRegistry.addPotion(fluidEternalFlameLong, vials, "EternalFlameLong", ModMobEffects.FLAME, 30, 0);
		potionRegistry.addPotion(fluidEternalFlameVeryLong, vials, "EternalFlameVeryLong", ModMobEffects.FLAME, 60, 0);
		potionRegistry.addPotion(fluidFireImmunity, vials, "FireImmunity", ModMobEffects.FIREPROOF, 10, 0, true);
		potionRegistry.addPotion(fluidFireImmunityLong, vials, "FireImmunityLong", ModMobEffects.FIREPROOF, 70, 0, true);
		potionRegistry.addPotion(fluidFireImmunityVeryLong, vials, "FireImmunityVeryLong", ModMobEffects.FIREPROOF, 140, 0, true);
		potionRegistry.addPotion(fluidFireImmunityII, vials, "FireImmunityII", ModMobEffects.FIREPROOF, 15, 1, true);
		potionRegistry.addPotion(fluidFireImmunityIII, vials, "FireImmunityIII", ModMobEffects.FIREPROOF, 10, 2, true);
		potionRegistry.addPotion(fluidFireImmunityIIII, vials, "FireImmunityIIII", ModMobEffects.FIREPROOF, 5, 3, true);
		potionRegistry.addPotion(fluidFireEater, vials, "FireEater", ModMobEffects.FIRE_EATER, 15, 0, true);
		potionRegistry.addPotion(fluidFireEaterII, vials, "FireEaterII", ModMobEffects.FIRE_EATER, 10, 1, true);
		potionRegistry.addPotion(fluidFireEaterIII, vials, "FireEaterIII", ModMobEffects.FIRE_EATER, 5, 2, true);
		potionRegistry.addPotion(fluidFireEaterLong, vials, "FireEaterLong", ModMobEffects.FIRE_EATER, 45, 0, true);
		potionRegistry.addPotion(fluidFireEaterVeryLong, vials, "FireEaterVeryLong", ModMobEffects.FIRE_EATER, 90, 0,  true);
		...
		potionRegistry.addPotion(fluidRegenIII, big, "RegenIII", ModMobEffects.REGENERATION, 23, 2);
		...
		potionRegistry.addPotion(fluidPoisonIII, big, "PoisonIII", ModMobEffects.POISON, 23, 2);
		...
		potionRegistry.addPotion(fluidWitherIII, big, "WitherIII", ModMobEffects.WITHER, 10, 2);
		...
		potionRegistry.addPotion(fluidHolyWater, big, "HolyWater", ModMobEffects.ANGEL, 20, 0, true);
		potionRegistry.addPotion(fluidHolyWaterII, big, "HolyWaterII", ModMobEffects.ANGEL, 10, 1, true);
		potionRegistry.addPotion(fluidHolyWaterLong, big, "HolyWaterLong", ModMobEffects.ANGEL, 40, 0, true);
		potionRegistry.addPotion(fluidHolyWaterVeryLong, big, "HolyWaterVeryLong", ModMobEffects.ANGEL, 80, 0, true);
		potionRegistry.addPotion(fluidHolyWaterIII, big, "HolyWaterIII", ModMobEffects.ANGEL, 5, 2, true);
		potionRegistry.addPotion(fluidFlight, big, "Flight", ModMobEffects.FLIGHT, 30, 0);
		potionRegistry.addPotion(fluidFlightLong, big, "FlightLong", ModMobEffects.FLIGHT, 60, 0);
		potionRegistry.addPotion(fluidFlightVeryLong, big, "FlightVeryLong", ModMobEffects.FLIGHT, 120, 0);
		potionRegistry.addPotion(fluidAntidote, big, "Antidote", ModMobEffects.IMMUNITY, 120, 0, true);
		potionRegistry.addPotion(fluidAntidoteII, big, "AntidoteII", ModMobEffects.IMMUNITY, 60, 1, true);
		potionRegistry.addPotion(fluidAntidoteIII, big, "AntidoteIII", ModMobEffects.IMMUNITY, 30, 2, true);
		potionRegistry.addPotion(fluidAntidoteIIII, big, "AntidoteIIII", ModMobEffects.IMMUNITY, 15, 3, true);
		potionRegistry.addPotion(fluidAntidoteLong, big, "AntidoteLong", ModMobEffects.IMMUNITY, 240, 0, true);
		potionRegistry.addPotion(fluidAntidoteVeryLong, big, "AntidoteVeryLong", ModMobEffects.IMMUNITY, 480, 0, true);
		potionRegistry.addPotion(fluidBoom, big, "Boom", ModMobEffects.CREEPER, 16, 0, true);
		potionRegistry.addPotion(fluidBoomII, big, "BoomII", ModMobEffects.CREEPER, 8, 1, true);
		potionRegistry.addPotion(fluidBoomIII, big, "BoomIII", ModMobEffects.CREEPER, 4, 2, true);
		potionRegistry.addPotion(fluidBoomLong, big, "BoomLong", ModMobEffects.CREEPER, 32, 0, true);
		potionRegistry.addPotion(fluidBoomVeryLong, big, "BoomVeryLong", ModMobEffects.CREEPER, 64, 0, true);
		potionRegistry.addPotion(fluidCryo, big, "Cryo", ModMobEffects.FROZEN, 16, 0, true);
		potionRegistry.addPotion(fluidCryoLong, big, "CryoLong", ModMobEffects.FROZEN, 32, 0, true);
		potionRegistry.addPotion(fluidCryoVeryLong, big, "CryoVeryLong", ModMobEffects.FROZEN, 64, 0, true);
		potionRegistry.addPotion(fluidEternalFlame, big, "EternalFlame", ModMobEffects.FLAME, 60, 0);
		potionRegistry.addPotion(fluidEternalFlameLong, big, "EternalFlameLong", ModMobEffects.FLAME, 120, 0);
		potionRegistry.addPotion(fluidEternalFlameVeryLong, big, "EternalFlameVeryLong", ModMobEffects.FLAME, 240, 0);
		potionRegistry.addPotion(fluidFireImmunity, big, "FireImmunity", ModMobEffects.FIREPROOF, 70, 0, true);
		potionRegistry.addPotion(fluidFireImmunityLong, big, "FireImmunityLong", ModMobEffects.FIREPROOF, 140, 0, true);
		potionRegistry.addPotion(fluidFireImmunityVeryLong, big, "FireImmunityVeryLong", ModMobEffects.FIREPROOF, 280, 0, true);
		potionRegistry.addPotion(fluidFireImmunityII, big, "FireImmunityII", ModMobEffects.FIREPROOF, 35, 1, true);
		potionRegistry.addPotion(fluidFireImmunityIII, big, "FireImmunityIII", ModMobEffects.FIREPROOF, 20, 2, true);
		potionRegistry.addPotion(fluidFireImmunityIIII, big, "FireImmunityIIII", ModMobEffects.FIREPROOF, 10, 3, true);
		potionRegistry.addPotion(fluidFireEater, big, "FireEater", ModMobEffects.FIRE_EATER, 90, 0, true);
		potionRegistry.addPotion(fluidFireEaterII, big, "FireEaterII", ModMobEffects.FIRE_EATER, 45, 1, true);
		potionRegistry.addPotion(fluidFireEaterIII, big, "FireEaterIII", ModMobEffects.FIRE_EATER, 23, 2, true);
		potionRegistry.addPotion(fluidFireEaterLong, big, "FireEaterLong", ModMobEffects.FIRE_EATER, 180, 0, true);
		potionRegistry.addPotion(fluidFireEaterVeryLong, big, "FireEaterVeryLong", ModMobEffects.FIRE_EATER, 360, 0, true);
	}
